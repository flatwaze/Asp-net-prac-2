...
namespace WebStore.Tests.Controllers
{
    ...
    public class CartControllerTests
    {
        ...
        {
            var cart_mock = new Mock<ICartService>();
            var order_mock = new Mock<IOrdersService>();
            var controller = new CartController(cart_mock.Object, order_mock.Object);
            controller.ModelState.AddModelError("error", "InvalidModel");
            const string expected_model_name = "Test order";
            var result = controller.CheckOut(new OrderViewModel { Name = expected_model_name }, order_mock.Object);
        ...
        public void CheckOut_Calls_Service_and_Return_Redirect()
        {
            ...
            order_mock
                ...
                .Returns(new OrderDTO { Id = expected_id });
            ...
            Assert.Equal(expected_id, redirect_result.RouteValues["id"]);
        }
    }
}
