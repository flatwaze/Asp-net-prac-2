...
{
    [Route(WebStore.DomainNew.WebApi.Users)]
    [ApiController]
    public class UsersAPIController : ControllerBase
    {
        private readonly UserStore<User, Role, WebStoreContext> _UserStore;

        public UsersAPIController(WebStoreContext context) => _UserStore = new UserStore<User, Role, WebStoreContext>(context);
